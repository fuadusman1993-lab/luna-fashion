      ...
      <div className="w-full min-h-screen sm:min-h-[600px] sm:h-auto sm:max-h-[85vh] sm:max-w-[420px] bg-luna-white dark:bg-luna-black sm:rounded-3xl flex flex-col justify-between overflow-y-auto sm:border border-gray-200 dark:border-gray-800 shadow-2xl relative">
        ...
        <div className="relative h-[30vh] flex items-center justify-center p-6 bg-black rounded-t-none sm:rounded-t-3xl mt-0">
          ...
          <motion.div 
            ...
            className="relative z-10 flex flex-col items-center justify-center h-full w-full px-4 space-y-3"
          >
            {/* White pill with Black text for 'WELCOME TO' */}
            <div className="bg-white px-4 py-1.5 rounded-full shadow-[0_0_10px_rgba(255,255,255,0.2)]">
              <span className="text-black font-bold tracking-[0.2em] uppercase text-xs">
                WELCOME TO
              </span>
            </div>
            
            {/* Gold text for 'LUNA FASHION' */}
            <h1 className="text-4xl md:text-5xl font-serif font-bold tracking-[0.15em] text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] drop-shadow-[0_0_15px_rgba(212,175,55,0.5)] text-center uppercase">
              LUNA FASHION
            </h1>
          </motion.div>
        </div>
