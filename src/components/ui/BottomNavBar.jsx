...
export default function BottomNavBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full bg-luna-white dark:bg-[#0a0a0a] border-t border-gray-100 dark:border-gray-900 z-50 flex justify-around items-center pt-2 pb-5 sm:max-w-[480px] sm:mx-auto sm:border-x sm:border-gray-200 sm:dark:border-gray-800 px-2 pb-safe">
       {navItems.map((item) => {
